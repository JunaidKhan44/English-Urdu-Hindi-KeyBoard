...
public class FlagAdapter  extends  RecyclerView.Adapter<FlagAdapter.MyHolder> {
    ...
    public FlagAdapter(Context context, ArrayList<FlagModel> arrayList) {
    ...
    @NonNull
    @Override
    public FlagAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.theme_item, null);
        return new FlagAdapter.MyHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FlagAdapter.MyHolder holder, int position) {
        ...
        if(loadsharedString().equalsIgnoreCase("flag")){
        ...
        holder.dapply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString(GROUPSNAME_SHARED_PREF, "flag");
